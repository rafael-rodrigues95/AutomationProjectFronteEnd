...
class ClassRoboList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      robos: [],
  ...
  render() {
    const ClassRoboList = this.state.robos.map((robo) => {
      return (
        <tr>
          <td>
            <label>
    ...
    return (
      <div>
        ...
        <p>&nbsp;</p>
          ...
          <p>&nbsp;</p>
          <button className="btn btn-primary" onClick={this.newClassRoboList}>
            Robô Lista
          </button>
